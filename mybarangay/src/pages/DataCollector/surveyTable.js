        ...
        <thead>
          <tr>
            {Object.keys(surveyTable[0]).map((item, index) =>{
                return(
                    <th className='table-head-item' key={index}>{item}</th>
                )
            })}
          </tr>
        </thead>
          ...
          {surveyTable.map((item, index) =>{
                return(
                    <tr key={index}>
                        ...
                        <td className='survey survey-loc'> {item["Location allocated"]}</td>
                        <td className='survey survey-population'>{item["Population"]}</td>
